...
PortfolioCard.create!([{
    portfolio_card_title: "Dumpster Rentals | Junk Removal",
    portfolio_card_description: "Fast and affordable dumpster delivery options, servicing the greater Pennsylvania area",
